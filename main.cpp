...
int main(int argc, char *argv[])
{
    ...
    soundMngr->initFields(0,false,QUrl("qrc:/Sound/crash_padle.wav"));
    ...
    sound2Mngr->initFields(0,false,QUrl("qrc:/Sound/temp.wav"));
    ...
    sound3Mngr->initFields(0,false,QUrl("qrc:/Sound/grenade.mp3"));
